...
```{r}
#### only including the true zeros and nonzeros
...
library(VGAM)
df_nb_true0_all<- df_nb_true0[,-1]
fit_nb<- vglm(formula = df_nb_true0_all$num_of_drinks ~., family = posnegbinomial(), 
              data = df_nb_true0_all)
summary(fit_nb)
